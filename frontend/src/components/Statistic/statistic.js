...
//     root[name] = factory();
//   }
// }(this, 'ReportOverviewModule', () => {
//   const ReportOverview = ReportOverviewConstructor;
...
//       const id = $('canvas').length;
//       const canvasElement = $(`<canvas id="${id}" width="${canvasWidth}" height="${canvasHeight}"></canvas>`);
//       const canvas = canvasElement.get(0).getContext('2d');
//       const centerX = canvasWidth / 2;
//       const centerY = canvasHeight / 2;
//       const radius = settings.width / 2 - settings.barWeight / 2;
//       const counterClockwise = false;
//       const fps = 1000 / settings.fps;
//       const update = 0.01;
...
//   const $el = $('.report-overview-module');
