  ...
  return (<div className='Methodology'>
    ...
    <td>
      <p><ul className="list-group">
        <li className="list-group-item list-group-item-primary"><strong>Любовь Васильевна Петрова</strong>
    ...
    <td>
      <p>
        <ul className="list-group">
          <li className="list-group-item list-group-item-primary"><strong>Сергей Иванович Мишустин</strong>
