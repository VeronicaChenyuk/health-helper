...
import { Nav, NavLink, Card, Button, CardImg, CardTitle, CardText, CardGroup, CardSubtitle, CardBody} from 'reactstrap';
...
<CardGroup>
      <Card>
        ...
        <CardBody>
          ...
          {patients[0].name} выполняет все предписания
          <br/>
          Держится молодцом: кровать застилает, чистит зубы
          <br/>
          <Button>Полный отчет</Button>
        </CardBody>
      </Card>
      <Card>
        ...
        <CardBody>
          ...
          <CardText> {patients[0].name} принимает 10 таблеток фенозипама 3 раза в день перед едой! <br/> Делает клизму перед сном (5л) вместе со снотворным
          
          </CardText>
          <Button>Изменить методику</Button>
        </CardBody>
      </Card>
      <Card>
        ...
        <CardBody>
          ...
          <CardText>Нажав на кнопку, вы откроете чат с {patients[0].name}, в котором сможете с ним пообщаться.</CardText>
          <Button>Чат</Button>
        </CardBody>
      </Card>
    </CardGroup>
